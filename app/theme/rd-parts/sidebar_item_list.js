RD.add_part( "sidebar_item_list.default", `\`\`+ function(){ var attr_data = undefined; var data = ( ( ! parsed_data ) ? attr_data : parsed_data ); var html = \`
    <div class="t-products p-4">
        <h6 class="text-uppercase py-2 border-bottom">Computer &amp; Periferals<\/h6>
        <div class="p-lists">
